...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.soul.yaml)")
...
func initConfig() {
	...
	viper.SetConfigName(".soul") // name of config file (without extension)
